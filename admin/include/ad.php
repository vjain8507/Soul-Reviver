...
<table>
    ...
    <tbody>
        <?php
            $run_ad = mysqli_query($con,"select * from ad order by ad_id desc");
            $i=1;
            while($row_ad = mysqli_fetch_array($run_ad))
            {
                ...
                echo "<tr><td>".$i++."</td><td><img src='../../image/ads/$ad_image' width='200px'></td><td>";
                if($ad_status=='1')
                ...
                echo "</td><td><a href='./home.php?delete_ad&de=$ad_id'><i class='material-icons'>delete_forever</i></a></td></tr>";
            }
        ?>
    </tbody>
</table>
