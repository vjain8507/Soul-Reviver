...
<form action="./home.php?edit_event&ev=<?php echo $event_id; ?>" method="post" enctype="multipart/form-data">
    <table>
        ...
        <tr>
            ...
            <td>
                <div class="mdl-textfield mdl-js-textfield">
                    <input name="image" class="mdl-textfield__input" type="file" id="image"><img src="../../image/news-events/<?php echo $event_image; ?>" width="60" height="60" />
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr colspan="2" style="text-align:center;">
            <td><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="edit_event">Add</button></td>
        </tr>
    </table>
</form>
<?php
	if(isset($_POST['edit_event']))
	{
		...
		{
            move_uploaded_file($event_image_tmp,"../../image/news_events/$event_image");
			$insert_event = "update nevent set event_title='$event_title', event_image='$event_image', event_date='$event_date', event_time='$event_time', event_venue='$event_venue', event_cord='$event_cord', event_detail='$event_detail' where event_id='$edit_id'";
