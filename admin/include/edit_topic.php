...
<form action="./home.php?edit_topic&ev=<?php echo $sno; ?>" method="post" enctype="multipart/form-data">
    <table>
        ...
        <tr colspan="2" style="text-align:center;">
            <td><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="edit_topic">Add</button></td>
        </tr>
    </table>
</form>
<?php
	if(isset($_POST['edit_topic']))
	{
		...
		else
		{
			...
			$insert_topic = "update ttopic set heading='$heading', image='$image', author='$author', date='$date', content='$content' where sno='$edit_id'";
