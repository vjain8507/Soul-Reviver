    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-success">
                <div class="panel-heading"><h2>EDIT DETAIL</h2></div>
                <div class="panel-body">
                    <form action="./?signup" method="post" enctype="multipart/form-data">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>EMAIL ADDRESS</td>
                                <td><input name="email" type="email" value="<?php echo $log_email; ?>" required></td>
                            </tr>
                            <tr>
                                <td>MOBILE NUMBER</td>
                                <td><div class="input-group"><span class="input-group-addon">+91</span><input name="mobile" type="tel" value="<?php echo $log_mobile; ?>" required></div></td>
                            </tr>
                            <tr>
                                <td>ADDRESS</td>
                            ...
                            <tr>
                                <td>ZIP CODE</td>
                                <td><input name="zip" type="text" value="<?php echo $log_zip; ?>"></td>
                            </tr>
                            <tr>
...
<?php
	...
	if(isset($_POST['submit']))
	{
        ...
        {
            move_uploaded_file($log_image_tmp,"image/users/$log_image");
            $insert_log = "insert into login (log_image,log_name,log_gender,log_email,log_mobile,log_address,log_city,log_state,log_zip,log_password,log_plan) values ('$log_image','$log_name','$log_gender','$log_email','$log_mobile','$log_address','$log_city','$log_state','$log_zip','$log_password','$log_plan')";
